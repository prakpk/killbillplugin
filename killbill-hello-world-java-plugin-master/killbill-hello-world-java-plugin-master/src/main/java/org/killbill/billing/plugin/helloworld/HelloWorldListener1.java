...
public class HelloWorldListener implements OSGIKillbillEventDispatcher.OSGIKillbillEventHandler {
    ...
    private void handlePaymentFailed(final ExtBusEvent event, final PluginTenantContext context) {
        UUID paymentId = event.getObjectId(); // Assuming the objectId here is the paymentId
    ...
    private void handlePaymentSuccess(final ExtBusEvent event, final PluginTenantContext context) {
        UUID paymentId = event.getObjectId(); // Assuming the objectId here is the paymentId
