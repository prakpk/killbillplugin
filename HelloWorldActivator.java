...
public class HelloWorldActivator extends KillbillActivatorBase {
    ...
    public void start(final BundleContext context) throws Exception {
        ...
        // Retrieve webhook URL from your configuration
        final String webhookUrl = configProperties.getString("webhookUrl");

        // Make sure to pass the webhook URL to your listener
        killbillEventHandler = new HelloWorldListener(killbillAPI, webhookUrl);
